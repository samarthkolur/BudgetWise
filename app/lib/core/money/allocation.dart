...
class Allocation<T> {
  const Allocation({required this.key, required this.percent, required this.amount});
...
enum SavingsMode {
  ...
  static SavingsMode fromDb(String value) =>
      SavingsMode.values.firstWhere((m) => m.name == value, orElse: () => SavingsMode.percent);
}
